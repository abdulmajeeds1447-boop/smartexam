...
export const ExamManagement: React.FC = () => {
  ...
  // ✅ [FIX] القفل الذكي: يمنع حركة الصفحة الخلفية، لكن النوافذ أدناه مصممة لتقبل التمرير
  useEffect(() => {
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-20">
      ...
      {/* ✅ [Updated] مودال الاستلام بالماسح - متجاوب وقابل للتمرير */}
      {showReceiveScanner && (
        <div className="fixed inset-0 z-[100] overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                ...
                {/* الحاوية القابلة للتمرير والوسط */}
                <div className="relative transform overflow-hidden rounded-[2.5rem] bg-white text-left shadow-xl transition-all sm:my-8 w-full max-w-md border border-white/10">
      ...
      {/* ✅ [Updated] مودال QR الخاص باللجنة - متجاوب وقابل للتمرير */}
      {selectedCommittee && (
        <div className="fixed inset-0 z-[100] overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
             <div className="fixed inset-0 bg-black/90 transition-opacity" onClick={() => setSelectedCommittee(null)}></div>
             <div className="relative transform overflow-hidden rounded-[2rem] bg-white p-8 text-center shadow-2xl transition-all sm:my-8 w-full max-w-sm">
      ...
      {/* ✅ [Updated] Wizard Modal - متجاوب وقابل للتمرير */}
      {showWizard && (
          <div className="fixed inset-0 z-[100] overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
       ...
       {/* ✅ [Updated] Delete Modal - متجاوب وقابل للتمرير */}
       {showDeleteModal && (
          <div className="fixed inset-0 z-[100] overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
